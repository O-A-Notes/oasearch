{
    const e = $("#searchbar input"); let t = [
        ...
        const n = $("#search-result"); if (n.innerHTML = "", e.classList.remove("expanded"), !e.value.trim()) return; new Promise(e => { if (t.length > 0) { e(t); return } fetch("https://raw.githubusercontent.com/O-A-Notes/oasearch/main/pages.json").then(e => e.json()).then(n => { t = n, e(n) }) }).then(() => {
